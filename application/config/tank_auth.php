...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'Tundra';
$config['webmaster_email'] = 'noreply@tundra.projects.chrisatk.in';
...
|--------------------------------------------------------------------------
*/
$config['autologin_cookie_name'] = 'tundra_autologin';
...
$config['recaptcha_public_key'] = '6Le6KcgSAAAAAMOM4FBEzMzOxcRE-Xa9cblXN9su';
$config['recaptcha_private_key'] = '6Le6KcgSAAAAAKagNv8JwYTd7roXVWPqRhKQ0CXu';
