<?php
/**
 * Ported verbatim from application/views/email/reset_password-html.php.
 * Not currently wired up -- Tank Auth's own change_password() never sent
 * an email either (see application/controllers/auth.php), and Shield's
 * magic-link login replaces the forgot/reset flow that would have used
 * this. Kept for reference/parity.
 */
?>
